        ...
        <div className="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white">
            ...
            <div className="container mx-auto px-6 py-10 flex flex-col md:flex-row gap-6 md:gap-10">
                    ...
                    <div className="social-icons flex flex-wrap gap-4 sm:gap-6 items-center justify-center my-6">
                        {[
                            ...
                            <a 
                                ...
                                href={item.link} 
                                target="_blank" 
                                className="social-button border-t-2 hover:border-0 bg-gray-200 dark:bg-gray-800 p-2 rounded text-sm flex items-center gap-2 text-gray-800 dark:text-gray-200"
                            >
                ...
                <div className="w-full md:w-1/3">
                    ...
                    {/* Latest News */}
                    <div className="mt-6">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-300 border-b-2 pb-2 border-gray-500 dark:border-gray-700">
                            LATEST NEWS
                        </h3>
                        <ul className="mt-2">
                            {[
                                ...
                                <li key={index} className="mt-2">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400 text-sm">{news.date}</p>
                                </li>
                            ))}
                        </ul>
                    </div>
